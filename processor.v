...
module RISCprocessor (
  ...
  wire [7:0] PC_D1;
    ...
    wire [7:0] INportDataout;
    reg [7:0] OUTportDataout;
  
  	
  wire [7:0] Mux1In [0:31];
    assign Mux1In[0]  = 8'b00000000;
    assign Mux1In[1]  = 8'b00000000;
    assign Mux1In[2]  = 8'b00000000;
    assign Mux1In[3]  = 8'b00000000;
    assign Mux1In[4]  = 8'b00000000;
    assign Mux1In[5]  = 8'b00000000;
    assign Mux1In[6]  = 8'b00000000;
    assign Mux1In[7]  = 8'b00000000;
    assign Mux1In[8]  = 8'b00000000;
    assign Mux1In[9]  = 8'b00000000;
    assign Mux1In[10] = 8'b00000000;
    assign Mux1In[11] = 8'b00000000;
    assign Mux1In[12] = 8'b00000000;
  	assign Mux1In[13] = Imm; 
  	assign Mux1In[14] = Imm; 
  	assign Mux1In[15] = Imm; 
  	assign Mux1In[16] = Imm; 
  	assign Mux1In[17] = Imm; 
    assign Mux1In[18] = 8'b00000000;
    assign Mux1In[19] = 8'b00000000;
    assign Mux1In[20] = 8'b00000000;
    assign Mux1In[21] = 8'b00000000;
    assign Mux1In[22] = 8'b00000000;
    assign Mux1In[23] = 8'b00000000;
    assign Mux1In[24] = 8'b00000000;
    assign Mux1In[25] = 8'b00000000;
    assign Mux1In[26] = 8'b00000000;
  	assign Mux1In[27] = ALUout; 
  	assign Mux1In[28] = ALUout;
    assign Mux1In[29] = 8'b00000000;
    assign Mux1In[30] = 8'b00000000;
    assign Mux1In[31] = 8'b00000000;

  wire [7:0] Mux1_out;
  
  wire [255:0] Mux1In_flat;
  assign Mux1In_flat = {Mux1In[31], Mux1In[30], Mux1In[29], Mux1In[28], Mux1In[27], Mux1In[26], Mux1In[25], Mux1In[24], Mux1In[23], Mux1In[22], Mux1In[21], Mux1In[20], Mux1In[19], Mux1In[18], Mux1In[17], Mux1In[16], Mux1In[15], Mux1In[14], Mux1In[13], Mux1In[12], Mux1In[11], Mux1In[10], Mux1In[9], Mux1In[8], Mux1In[7], Mux1In[6], Mux1In[5], Mux1In[4], Mux1In[3], Mux1In[2], Mux1In[1], Mux1In[0]};
  
  MUX32to1_8bit_withE Mux32to1_8bit__inst1(Opcode, 1'b1, Mux1In_flat, Mux1_out);
  
 
    // Instantiate modules
  
  TimingGen TimingGen_inst(
    .clk(clk),
    .Reset(Reset),
    .T0(T0),
    .T1(T1),
    ...
    ProgCounter PC_inst (
        ...
        .Reset(Reset),
      	.PCenable(T0), 
        .PCupdate(PCupdate),
      .CAddress(Mux1_out), // PC update from ALU result
        .PC(PC),
      	.PC_D1(PC_D1),
        .PC_D2(PC_D2)
    );
  ...
  wire [7:0] Mux2In [0:31];
    assign Mux2In[0]  = 8'b00000000;
  assign Mux2In[1]  = ALUout; 
  assign Mux2In[2]  = ALUout; 
  assign Mux2In[3]  = ALUout; 
  assign Mux2In[4]  = ALUout; 
  assign Mux2In[5]  = ALUout; 
  assign Mux2In[6]  = ALUout; 
  assign Mux2In[7]  = ALUout; 
  assign Mux2In[8]  = ALUout; 
  assign Mux2In[9]  = ALUout; 
  assign Mux2In[10] = ALUout; 
    assign Mux2In[11] = SRAMDataout;
    assign Mux2In[12] = 8'b00000000;
  assign Mux2In[13] = 8'b00000000;  
  assign Mux2In[14] = 8'b00000000;  
  assign Mux2In[15] = 8'b00000000;  
  assign Mux2In[16] = 8'b00000000;  
  assign Mux2In[17] = 8'b00000000;  
    assign Mux2In[18] = 8'b00000000;
    assign Mux2In[19] = StackDataout;
  assign Mux2In[20] = INportDataout;
    assign Mux2In[21] = 8'b00000000;
    assign Mux2In[22] = SRAMDataout;
    assign Mux2In[23] = 8'b00000000;
    assign Mux2In[24] = ALUout; 
    assign Mux2In[25] = ALUout; 
    assign Mux2In[26] = ALUout; 
  assign Mux2In[27] = 8'b00000000;  
  assign Mux2In[28] = 8'b00000000; 
    assign Mux2In[29] = 8'b00000000;
    assign Mux2In[30] = 8'b00000000;
    assign Mux2In[31] = 8'b00000000;

  wire [7:0] Mux2_out;
  
  wire [255:0] Mux2In_flat;
  assign Mux2In_flat = {Mux2In[31], Mux2In[30], Mux2In[29], Mux2In[28], Mux2In[27], Mux2In[26], Mux2In[25], Mux2In[24], Mux2In[23], Mux2In[22], Mux2In[21], Mux2In[20], Mux2In[19], Mux2In[18], Mux2In[17], Mux2In[16], Mux2In[15], Mux2In[14], Mux2In[13], Mux2In[12], Mux2In[11], Mux2In[10], Mux2In[9], Mux2In[8], Mux2In[7], Mux2In[6], Mux2In[5], Mux2In[4], Mux2In[3], Mux2In[2], Mux2In[1], Mux2In[0]};
  
  MUX32to1_8bit_withE Mux32to1_8bit__inst2(Opcode, 1'b1, Mux2In_flat, Mux2_out);

  //////////////////////////////// Operand 1 mux: ///////////////////////////////
  wire [7:0] Mux3In [0:31];
    assign Mux3In[0]  = 8'b00000000;
  	assign Mux3In[1]  = RegData1;  
  	assign Mux3In[2]  = RegData1;  
  	assign Mux3In[3]  = RegData1;  
  	assign Mux3In[4]  = RegData1;  
  	assign Mux3In[5]  = RegData1;  
  	assign Mux3In[6]  = RegData1;  
  	assign Mux3In[7]  = RegData1;  
  	assign Mux3In[8]  = RegData1;  
  	assign Mux3In[9]  = RegData1;  
  	assign Mux3In[10] = 8'b00000000;
    assign Mux3In[11] = 8'b00000000;
  	assign Mux3In[12] = RegData1; 
  	assign Mux3In[13] = 8'b00000000;  
  	assign Mux3In[14] = 8'b00000000;  
  	assign Mux3In[15] = 8'b00000000;  
  	assign Mux3In[16] = 8'b00000000;  
  	assign Mux3In[17] = 8'b00000000;  
  	assign Mux3In[18] = RegData1;
    assign Mux3In[19] = 8'b00000000;
  	assign Mux3In[20] = 8'b00000000;
  	assign Mux3In[21] = RegData1; 
    assign Mux3In[22] = 8'b00000000;
    assign Mux3In[23] = 8'b00000000;
    assign Mux3In[24] = RegData1; 
    assign Mux3In[25] = RegData1; 
    assign Mux3In[26] = RegData1; 
  	assign Mux3In[27] = PC_D2;  
  	assign Mux3In[28] = PC_D2; 
    assign Mux3In[29] = 8'b00000000;
    assign Mux3In[30] = 8'b00000000;
    assign Mux3In[31] = 8'b00000000;

  wire [7:0] Mux3_out;
  
  wire [255:0] Mux3In_flat;
  assign Mux3In_flat = {Mux3In[31], Mux3In[30], Mux3In[29], Mux3In[28], Mux3In[27], Mux3In[26], Mux3In[25], Mux3In[24], Mux3In[23], Mux3In[22], Mux3In[21], Mux3In[20], Mux3In[19], Mux3In[18], Mux3In[17], Mux3In[16], Mux3In[15], Mux3In[14], Mux3In[13], Mux3In[12], Mux3In[11], Mux3In[10], Mux3In[9], Mux3In[8], Mux3In[7], Mux3In[6], Mux3In[5], Mux3In[4], Mux3In[3], Mux3In[2], Mux3In[1], Mux3In[0]};
  
  MUX32to1_8bit_withE Mux32to1_8bit__inst3(Opcode, 1'b1, Mux3In_flat, Mux3_out);
 
//////////////////////////////// Operand 2 mux: ///////////////////////////////
 
  wire [7:0] Mux4In_27;
  assign Mux4In_27 = {1'b0, Imm[6:0]}; 
    
  wire [7:0] Mux4In [0:31];
    assign Mux4In[0]  = 8'b00000000;
  	assign Mux4In[1]  = RegData2;  
  	assign Mux4In[2]  = RegData2;  
  	assign Mux4In[3]  = RegData2;  
  	assign Mux4In[4]  = RegData2;  
  	assign Mux4In[5]  = Imm;  
  	assign Mux4In[6]  = Imm;  
  	assign Mux4In[7]  = Imm;  
  	assign Mux4In[8]  = Imm;  
  	assign Mux4In[9]  = 8'b00000000; 
  	assign Mux4In[10] = Imm;
    assign Mux4In[11] = 8'b00000000;
  	assign Mux4In[12] = 8'b00000000;
  	assign Mux4In[13] = 8'b00000000;  
  	assign Mux4In[14] = 8'b00000000;  
  	assign Mux4In[15] = 8'b00000000;  
  	assign Mux4In[16] = 8'b00000000;  
  	assign Mux4In[17] = 8'b00000000;  
  	assign Mux4In[18] = 8'b00000000;
    assign Mux4In[19] = 8'b00000000;
  	assign Mux4In[20] = 8'b00000000;
  	assign Mux4In[21] = 8'b00000000; 
    assign Mux4In[22] = 8'b00000000;
  	assign Mux4In[23] = RegData2;
  	assign Mux4In[24] = RegData2; 
  	assign Mux4In[25] = RegData2; 
  	assign Mux4In[26] = RegData2; 
  	assign Mux4In[27] = Mux4In_27;  
  	assign Mux4In[28] = Mux4In_27; 
    assign Mux4In[29] = 8'b00000000;
    assign Mux4In[30] = 8'b00000000;
    assign Mux4In[31] = 8'b00000000;

  wire [7:0] Mux4_out;
  
  wire [255:0] Mux4In_flat;
  assign Mux4In_flat = {Mux4In[31], Mux4In[30], Mux4In[29], Mux4In[28], Mux4In[27], Mux4In[26], Mux4In[25], Mux4In[24], Mux4In[23], Mux4In[22], Mux4In[21], Mux4In[20], Mux4In[19], Mux4In[18], Mux4In[17], Mux4In[16], Mux4In[15], Mux4In[14], Mux4In[13], Mux4In[12], Mux4In[11], Mux4In[10], Mux4In[9], Mux4In[8], Mux4In[7], Mux4In[6], Mux4In[5], Mux4In[4], Mux4In[3], Mux4In[2], Mux4In[1], Mux4In[0]};
  
  MUX32to1_8bit_withE Mux32to1_8bit__inst4(Opcode, 1'b1, Mux4In_flat, Mux4_out);
  
  wire [7:0] Mux5In [0:31];
    assign Mux5In[0]  = 8'b00000000;
  	assign Mux5In[1]  = 8'b00000000;  
  	assign Mux5In[2]  = 8'b00000000;  
  	assign Mux5In[3]  = 8'b00000000;  
  	assign Mux5In[4]  = 8'b00000000;  
  	assign Mux5In[5]  = 8'b00000000;  
  	assign Mux5In[6]  = 8'b00000000;  
  	assign Mux5In[7]  = 8'b00000000;  
  	assign Mux5In[8]  = 8'b00000000;  
  	assign Mux5In[9]  = 8'b00000000; 
  	assign Mux5In[10] = 8'b00000000;
  	assign Mux5In[11] = Imm;
  	assign Mux5In[12] = Imm;
  	assign Mux5In[13] = 8'b00000000;  
  	assign Mux5In[14] = 8'b00000000;  
  	assign Mux5In[15] = 8'b00000000;  
  	assign Mux5In[16] = 8'b00000000;  
  	assign Mux5In[17] = 8'b00000000;  
  	assign Mux5In[18] = 8'b00000000;
    assign Mux5In[19] = 8'b00000000;
  	assign Mux5In[20] = 8'b00000000;
  	assign Mux5In[21] = 8'b00000000; 
  	assign Mux5In[22] = RegData1;
  	assign Mux5In[23] = RegData1;
  	assign Mux5In[24] = 8'b00000000;  
  	assign Mux5In[25] = 8'b00000000;  
  	assign Mux5In[26] = 8'b00000000;  
  	assign Mux5In[27] = 8'b00000000;  
  	assign Mux5In[28] = 8'b00000000; 
    assign Mux5In[29] = 8'b00000000;
    assign Mux5In[30] = 8'b00000000;
    assign Mux5In[31] = 8'b00000000;

  wire [7:0] Mux5_out;
    
  wire [255:0] Mux5In_flat;
  assign Mux5In_flat = {Mux5In[31], Mux5In[30], Mux5In[29], Mux5In[28], Mux5In[27], Mux5In[26], Mux5In[25], Mux5In[24], Mux5In[23], Mux5In[22], Mux5In[21], Mux5In[20], Mux5In[19], Mux5In[18], Mux5In[17], Mux5In[16], Mux5In[15], Mux5In[14], Mux5In[13], Mux5In[12], Mux5In[11], Mux5In[10], Mux5In[9], Mux5In[8], Mux5In[7], Mux5In[6], Mux5In[5], Mux5In[4], Mux5In[3], Mux5In[2], Mux5In[1], Mux5In[0]};
  
  MUX32to1_8bit_withE Mux32to1_8bit__inst5(Opcode, 1'b1, Mux5In_flat, Mux5_out);
  ...
  assign OutExtWorld1 = OUTportWrite ? OUTportDataout : 8'bZ;
assign OutExtWorld2 = OUTportWrite ? OUTportDataout : 8'bZ;
assign OutExtWorld3 = OUTportWrite ? OUTportDataout : 8'bZ;
assign OutExtWorld4 = OUTportWrite ? OUTportDataout : 8'bZ;
